                    ...
                    <div class="px-6 py-4">
                        ...
                        <form wire:submit.prevent="store" class="mt-4">
                            ...
                            <div>
                                ...
                                <!-- <input type="text" id="role" wire:model.defer="role" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md"> -->
